  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> Import Data - KTA</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../../">Home</a></li>
              <li class="breadcrumb-item"><a href="../course/">Uang Kursus</a></li>
              <li class="breadcrumb-item active">Import Data - KTA</li>              
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<script>
  $(document).ready(function(){
        ...
        success:function(data){
          ...
          if(data.row_data){
            for(var count = 0; count < data.row_data.length; count++){
              ...
              html += '<td class="pic" contenteditable>'+data.row_data[count].pic+'</td>';
              ...
              html += '<td hidden class="biaya_admin" contenteditable>'+data.row_data[count].biaya_admin+'</td>';
    ...
    $(document).on('click', '#import_data', function(){
      ...
      $('.pic').each(function(){pic.push($(this).text());});
      ...
      $('.biaya_admin').each(function(){biaya_admin.push($(this).text());});
