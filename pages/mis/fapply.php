<?PHP
  ...
  switch ($_GET['page']){
    default:  
      $Action     = "pages/mis/xapply.php?act=add";
    ...
    break;
    case "update";    
      $Action     = "pages/mis/xapply.php?act=edt&appid=$_GET[appid]";
      $Head_bg    = "card-lightblue card-outline";
    ...
    break;
    case "delete";    
      $Action     = "pages/mis/xapply.php?act=del&appid=$_GET[appid]";
      ...
      <div class="card-body">
        <form role="form" name="finput" id="myForm" method="post" action="<?PHP echo $Action; ?>" >
          <div class="tab-content" id="formcolumn">     
              ...
              <?PHP
                include_once('fcompletion.php');
                include_once('fpersonal.php');
                include_once('faddress.php');
                include_once('fprofession.php');
                include_once('femergency.php');
                include_once('fsubmission.php');
                include_once('fnote.php');
                include_once('fattachment.php');
              ?>
