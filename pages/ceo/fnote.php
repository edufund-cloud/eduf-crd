<?PHP
  ...
  $Table_Url = "pages/ceo/tapply.php";
?>
                ...
                <div class="form-group">  
                  ...
                  <div class="form-group clearfix">
                    <div class="icheck-info d-inline mr-3">
                      <input type="radio" name="rdoStatus" id="rdoStatus1" value="Approved">
                      <label for="rdoStatus1" class="font-weight-normal" >
                        Approved 
                      </label>
                    </div>
                    <div class="icheck-info d-inline mr-3">
                      <input type="radio" name="rdoStatus" id="rdoStatus2" value="Send Back CRO">
