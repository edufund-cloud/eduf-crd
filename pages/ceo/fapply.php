<?PHP
  ...
  $Self_Url   = "pages/ceo/fapply.php?page=".$_GET['page']."&appid=".$_GET['appid'];

  switch ($_GET['page']){
    default:  
      $Action     = "pages/ceo/xapply.php?act=add";
    ...
    break;
    case "update";    
      $Action     = "pages/ceo/xapply.php?act=edt&appid=$_GET[appid]";
      $Head_bg    = "card-lightblue card-outline";
    ...
    break;
    case "delete";    
      $Action     = "pages/ceo/xapply.php?act=del&appid=$_GET[appid]";
      ...
      <div class="col-md-12">
        <ol class="breadcrumb float-sm-left">
          ...
          <li class="breadcrumb-item text-info">
            ...
            <small class="fas fa-rotate mr-1"></small>Data Credit - CEO
            </a>
          </li>
        </ol>
      </div>      
