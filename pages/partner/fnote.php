<?PHP
  ...
  $Table_Url = "pages/partner/tapply.php";
?>
                  ...
                  if ($Status_Data == 'Equip'){
                    ...
                    <div class="form-group clearfix">
                      <div class="icheck-primary d-inline mr-4">
                        <input type="radio" name="rdoStatus" id="rdoStatus1" value="PV">
                        <label for="rdoStatus1" class="font-weight-normal" >
                          Done 
                        </label>
                      </div>
                      <div class="icheck-danger d-inline mr-2">
                        <input type="radio" name="rdoStatus" id="rdoStatus2" value="Pandding" hidden>
