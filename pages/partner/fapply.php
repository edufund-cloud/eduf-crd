<?PHP
  ...
  $Parent_Url = "pages/partner/tapply.php";

  switch ($_GET['page']){
    default:  
      $Action     = "pages/partner/xapply.php?act=add";
    ...
    break;
    case "update";    
      $Action     = "pages/partner/xapply.php?act=edt&appid=$_GET[appid]";
      $Head_bg    = "card-lightblue card-outline";
    ...
    break;
    case "delete";    
      $Action     = "pages/partner/xapply.php?act=del&appid=$_GET[appid]";
