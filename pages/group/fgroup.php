<?PHP
  ...
  $sql = "SELECT gg.description,gg.data_active
    FROM gen_group gg 
    WHERE gg.group_id = '$_GET[grpid]'";
  $xsql = mysqli_query($koneksi,$sql);
  $arsql = mysqli_fetch_array($xsql);

  switch ($_GET['page']){
    default:
      $Action     = "pages/group/xgroup.php?act=addgrp";
      $Head_bg    = "card-lightblue card-outline";      
      $Head_label = "Add Group User";
      $Head_icon  = "fa-plus";
      $Btn_label  = "Add New";
    ...
    break;
    case "update";    
      $Action     = "pages/group/xgroup.php?act=edtgrp&grpid=$_GET[grpid]";
      $Head_bg    = "card-lightblue card-outline";
      $Head_label = "Update Group User";
      $Head_icon  = "fa-edit";
      $Btn_label  = "Update";
      $Btn_color  = "btn-success";
      $Btn_icon   = "fa-edit";
    ...
    break;
    case "delete";    
      $Action     = "pages/group/xgroup.php?act=delgrp&grpid=$_GET[grpid]";
      $Head_bg    = "card-lightblue card-outline";
      $Head_label = "Delete Group";
    ...
    <div class="row mb-2">
      <div class="col-md-12">
        <ol class="breadcrumb float-sm-left">
          ...
          <li class="breadcrumb-item"><a onClick="javascript:load_right('<?PHP echo $Parent_Url; ?>')" style="cursor: pointer;" >Group User</a></li>
          ...
          <form role="form" name="finput" id="myForm" method="post" action="<?PHP echo $Action; ?>" >
            <div class="card-body">
              ...
              <div class="form-group row">
                <label for="txtDescription" class="col-sm-4 col-form-label">
                  Description<label class="badge bg-danger" style="margin-left: 10px;"> Required</label>
                </label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="txtDescription" name="txtDescription"  required 
                    placeholder="Description group" value="<?PHP echo $arsql['description']; ?>" <?PHP echo $Disabled; ?>>
                </div>
              </div>
              
              <div class="form-group row">
                <label for="cmbSysLevel" class="col-sm-4 col-form-label"></label>
                <div class="col-sm-8">
