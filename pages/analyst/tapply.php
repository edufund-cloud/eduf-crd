<?PHP
  ...
  $Parent_Url = "pages/analyst/tapply.php";
  $Form_Url = "pages/analyst/fapply.php";
    ...
    <div class="row mb-2">
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-left">
          ...
          <li class="breadcrumb-item active">Data Credit - Analyst</li>
        </ol>
      </div>     
    </div>
  </div><!-- /.container-fluid -->
  ...
  <div class="container-fluid">
    <div class="card card-lightblue card-outline" style="border-radius:12px;">
      <div class="card-header">
        <h3 class="card-title text-navy text-capitalize font-weight-bold"><i class="fa fa-list mr-2"></i>Data Credit - Analyst</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
