    ...
    <div class="row">
      ...
      <div class="col-12 col-md-12 col-lg-5 order-1 order-md-2">
        ...
        <div class="row mt-2">
          <div class="col-sm-12">
            <div class="form-group">
              <label for="txtNamaKontak">Cek Data</label>
                <?PHP
                  if ($Status_Data == 'Partner Process'){
                    ?>
                    <input type="text" name="txtKeyRadio" value="1" hidden>
                    <div class="form-group clearfix">
                      <div class="icheck-danger d-inline mr-4">
                        <input type="radio" name="rdoStatus" id="rdoStatus1" value="Reject">
                        <label for="rdoStatus1" class="font-weight-normal" >
                          Reject 
                        </label>
                      </div>
                      <div class="icheck-warning d-inline mr-2">
                        <input type="radio" name="rdoStatus" id="rdoStatus2" value="Rejected" hidden>
        ...
        <div class="text-center mt-5 mb-3">
          ...
          <button type="submit" class="btn btn-sm <?PHP echo $Btn_color; ?>" disabled> 
