<?PHP
  ...
  $Form_Url = "pages/tech/fapply.php";
  ...
  <div class="container-fluid">
    <div class="card card-lightblue card-outline" style="border-radius:12px;">
      <div class="card-header">
        <h3 class="card-title text-navy text-capitalize font-weight-bold"><i class="fa fa-list mr-2"></i>Data Credit - Tech</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
          ...
          <tbody>
            <?PHP
              ...
              while($arsql = mysqli_fetch_array($xsql)){
                if ($arsql['data_status'] == "Rejected"){
                  $Class_Status = "badge badge-secondary" ;
                  $Label_Status = $arsql['data_status'];
                }
                else if ($arsql['data_status'] == "Reject"){
                ...
                <tr ondblclick="javascript:load_right('<?PHP echo $Form_Url_Update; ?>');" style="cursor: pointer;">
                  ...
                  <td><?PHP echo $arsql['pic']; ?></td>
                  <td>
                    <label class="<?PHP echo $Class_Status; ?>"><?PHP echo $Label_Status; ?></label>
                  </td>
                  <td>
                    <div class="btn-group">
                      <button type="button" class="btn btn-warning btn-xs" style="margin-right: 5px; border-radius: 5px;"
