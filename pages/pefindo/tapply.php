<?PHP
  ...
  $Form_Url = "pages/pefindo/fapply.php";
    ...
    <div class="row mb-2">
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-left">
          ...
          <li class="breadcrumb-item active">Data Credit - Pefindo</li>
        </ol>
      </div>     
    </div>
  </div><!-- /.container-fluid -->
  ...
  <div class="container-fluid">
    <div class="card card-lightblue card-outline" style="border-radius:12px;">
      <div class="card-header">
        <h3 class="card-title text-navy text-capitalize font-weight-bold"><i class="fa fa-list mr-2"></i>Data Credit - Pefindo</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
