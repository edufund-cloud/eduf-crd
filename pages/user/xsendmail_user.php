...
$nmsql_host = mysqli_num_rows($xsql_host);
if ($nmsql_host > 0){
	...
	$to_name    = $txtNickName; // Nama penerima
	$subject    = 'Konfirmasi Pendaftaran User - '.$Host_From; // Judul Email
	...
	$capture_data .= '<tr>';
	$capture_data .= '<td style="font-size:28px;">';
	$capture_data .= 'Selamat Bergabung';
	$capture_data .= '</td>';
	$capture_data .= '</tr>';
	...
	$capture_data .= 'Berikut adalah password user sementara anda, silahkan login dan segera ubah password setelahnya.';
	$capture_data .= '</td>';
	$capture_data .= '</tr>';
