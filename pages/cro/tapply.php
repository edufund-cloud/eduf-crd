<?PHP
  ...
  $Parent_Url = "pages/cro/tapply.php";
  $Form_Url = "pages/cro/fapply.php";
    ...
    <div class="row mb-2">
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-left">
          ...
          <li class="breadcrumb-item active">Data Credit - CRO</li>
        </ol>
      </div>     
    </div>
  </div><!-- /.container-fluid -->
  ...
  <div class="container-fluid">
    <div class="card card-lightblue card-outline" style="border-radius:12px;">
      <div class="card-header">
        <h3 class="card-title text-navy font-weight-bold"><i class="fa fa-list mr-2"></i>Data Credit - CRO</h3>
      </div>
      <!-- /.card-header -->
      <div class="card-body">
          ...
          <tbody>
            <?PHP
              ...
              while($arsql = mysqli_fetch_array($xsql)){
                if ($arsql['data_status'] == "Recommended Analyst"){
                  $Class_Status = "badge badge-info" ;
                  $Label_Status = "Recommended";
                }
                else if ($arsql['data_status'] == "Send Back CRO"){
