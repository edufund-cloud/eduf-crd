<?PHP
  ...
  $Self_Url   = "pages/cro/fapply.php?page=".$_GET['page']."&appid=".$_GET['appid'];

  switch ($_GET['page']){
    default:  
      $Action     = "pages/cro/xapply.php?act=add";
    ...
    break;
    case "update";    
      $Action     = "pages/cro/xapply.php?act=edt&appid=$_GET[appid]";
      $Head_bg    = "card-lightblue card-outline";
    ...
    break;
    case "delete";    
      $Action     = "pages/cro/xapply.php?act=del&appid=$_GET[appid]";
      ...
      <div class="col-md-12">
        <ol class="breadcrumb float-sm-left">
          ...
          <li class="breadcrumb-item text-info">
            ...
            <small class="fas fa-rotate mr-1"></small>Data Credit - CRO
            </a>
          </li>
        </ol>
      </div>      
